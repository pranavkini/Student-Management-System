...
public class addStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(536, 493));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        stmt = conn.createStatement();
            ...
            String stdBoold = (String) blood.getSelectedItem();
            ...
            String sql = "INSERT INTO STUDENT (stdName, stdFatherName, stdBlood, stdCity, stdPhone,class ) VALUES ('"+stdName+"','"+stdFather+"','"+stdBoold+"','"+stdCity+"','"+stdPhone+"','"+stdclass+"')";
